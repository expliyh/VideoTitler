...
export type UiText = {
  ...
  renameSourceDirectoryConfirm: string;
  cancel: string;
  frame: string;
  startIndex: string;
  indexPadding: string;
  ...
  visionRecognition: string;
  ocrMode: string;
  includeSubdirs: string;
  dryRun: string;
  scanVideos: string;
  startProcess: string;
  startVisionProcess: string;
  ...
  saveVisionFailed: (message: string) => string;
  generateTitleFailed: (message: string) => string;
  renameSourceDirectoryFailed: (message: string) => string;
